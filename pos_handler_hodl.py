...
change_since_buy_profit_increment = 5
...
def positionHandler(ticker_symbol, buy_price, order_amount):
    ...
    while True:
        ...
        try:
            ...
            if change_since_buy > change_since_buy_profit_outset + change_since_buy_profit_increment and chk_profit2 == False:
                chk_profit2 = True
                if chk_trail1 == True:
                    sellFraction(ticker_symbol, 1)
                    lastCheck(ticker_symbol)
            ...
            if change_since_buy > change_since_buy_profit_outset + (change_since_buy_profit_increment * 2):
                chk_profit3 = True
                sellFraction(ticker_symbol, 1)
                lastCheck(ticker_symbol)
                return
